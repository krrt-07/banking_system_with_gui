...
# Define the BankAccount class
    # Initialize a bank account with balance, username, password, and full name details
    # Convert account data into a dictionary format for saving
    # Return the full name in proper format (with middle initial)
    # Verify account credentials for login
    # Add deposit amount to the balance if valid
    # Subtract withdrawal amount if there is enough balance
